    ...
    <main className="min-h-screen bg-[#f4f7f6] text-navy-900">
      ...
      <header className="max-w-7xl mx-auto px-6 py-5 flex items-center justify-between">
        ...
        <nav className="flex items-center gap-4 text-sm font-semibold">
          <Link href="/login" className="text-slate-600 hover:text-navy-900 transition">Login</Link>
          <Link href="/register" className="bg-navy-900 text-white px-5 py-2.5 rounded-xl hover:bg-navy-800 transition shadow-sm">
            Get Started
          </Link>
        </nav>
      </header>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20 grid lg:grid-cols-2 gap-16 items-center">
        <div>
          ...
          <div className="flex flex-wrap gap-4">
            <Link href="/register" className="bg-navy-900 text-white px-8 py-4 rounded-xl font-bold text-lg hover:bg-navy-800 transition shadow-md">
              Start Free Interview
            </Link>
            <Link href="/dashboard" className="bg-white border border-slate-200 text-navy-900 px-8 py-4 rounded-xl font-bold text-lg hover:shadow-soft transition shadow-sm">
              View Dashboard
            </Link>
          </div>
        </div>
