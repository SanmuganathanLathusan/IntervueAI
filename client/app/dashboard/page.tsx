        ...
        <div className="grid lg:grid-cols-[1fr_350px] gap-6">
          ...
          <div className="glass-panel flex flex-col h-[550px]">
            <div className="p-6 border-b border-slate-100 flex items-center justify-between">
              ...
              <Link href="/results" className="text-xs font-semibold text-aqua-600 hover:text-aqua-700">
                View All
              </Link>
            </div>
            ...
            <div className="flex-1 overflow-y-auto p-2">
              {report.interviews.length > 0 ? (
                ...
                <div className="flex flex-col items-center justify-center h-full text-center px-6 py-8">
                  ...
                  <Link href="/upload-pdf" className="text-xs font-bold text-aqua-600 hover:text-aqua-700 transition">
                    Start Now →
                  </Link>
                </div>
              )}
