      ...
      {!hideSidebar && (
        <aside className="w-64 flex-shrink-0 bg-white border-r border-slate-200 flex flex-col sticky top-0 h-screen overflow-y-auto">
          ...
          <div className="p-4 mb-4">
             <Link to="/upload-pdf" className="block w-full py-3 text-center rounded-xl bg-slate-100 text-slate-800 font-semibold border border-slate-200 hover:bg-slate-200 transition shadow-sm hover:shadow">
               New Session
             </Link>
          </div>
        </aside>
